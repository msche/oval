...
public class ResourceBundleMessageResolver implements MessageResolver
{
	...
	private final Map<ResourceBundle, List<String>> messageBundleKeys = new LinkedHashMap<>(8);
	private final Map<Locale, ArrayList<ResourceBundle>> messageBundlesByLocale = new LinkedHashMap<>(8);
